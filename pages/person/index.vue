<template>
    <div class="outdiv">
        ...
        <div class="bodyDiv">
            <position :positionName="position.name" style="font-size: 22px"></position>
            <el-card   shadow="hover" :body-style="{ padding: '20px'} " >
                <div class="display-row">
                    <el-col :span="2" style="min-width: 15%">
                        <el-menu
                        ...
                        >
                            ...
                            <el-menu-item  class="elstyle" index="1" @click="showAll">
                                <span slot="title" >全部</span>
                            </el-menu-item>
                            <el-menu-item class="elstyle" v-for="item in group" :key="item.id" :index="item.id"  @click="clickMenu(item.id)" >
                                <span>{{item.name}}</span>
                                <i class="el-icon-close" @click="deleteGroup(item.id)"></i>
                            </el-menu-item>
<!--                            <el-menu-item  class="elstyle">-->
<!--                                <el-button type="primary" plain  style="width: 80%" @click="dialogVisible = true" size="mini">新增</el-button>-->
<!--                            </el-menu-item>-->
                        </el-menu>
                    </el-col>
