    ...
    export default {
        ...
        data () {
            return {
                ...
                jingfeiurl:PRO.baseURL+'jixiao/import-data',
        ...
        methods: {
            ...
            Upload () {
                if(this.urltype === 'notify' || this.urltype === 'zhengji'){
                    ...
                    this.upurl = this.publicurl
                }else if(this.urltype ==='jixiao'){
                    this.upurl = this.jingfeiurl
                }
                ...
                if(this.urltype === 'notify'){
                    ...
                    param.append('class', this.msg.type);
                }
                    ...
                    axios.post(this.upurl, param, this.config)
                        .then(response => {
                            ...
                            if (response.data.code !== 0) {
                                ...
                                this.$emit('jingfeiurl', {url:response.data.data.url,filename:this.filename})
                                alert('上传成功！')
                            }
                        })
                }
