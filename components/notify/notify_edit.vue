    ...
    <div style="display: block;padding-left: 30px;padding-right: 30px;width: 100%" v-if="isshow">
        ...
        <div style="margin-top: 15px;width: 100%;" class="display-row">
            ...
            <div class="titleinput row-right">
                <el-input v-model="notifytitle" placeholder="请输入标题"></el-input>
            </div>
        </div>
        ...
        <div style="margin-top: 15px" class="display-row">
                ...
                <div class="titleinput row-right">
                    <el-input style="width: 100%" v-model="notifyRange" @click.native="dialogFormVisible = true" readonly="readonly" placeholder="点击选择发布范围"></el-input>
                </div>
        </div>
            ...
            <div>
                ...
                <div style="display: inline-block;width: 45%;margin-top: 20px">
                    <div style="border: 1px solid #5EBBDA;width: 100%;height: 250px;overflow-y: auto;border-radius: 5px;padding-left: 10px">
                        ...
                        <div class="tablerow" style="display: table-row;cursor: pointer;" v-if="rangeType===1" @click.stop="getxisuoList">
                ...
                <div style="display: inline-block;overflow: hidden;height: 510px;margin-left: 10px">
                    <div style="margin-top: 220px">
                        <el-button icon="el-icon-arrow-right" circle size="20px" @click="addRange"></el-button>
                    </div>
                    <div style="margin-top: 10px">
                        <el-button icon="el-icon-arrow-left" circle size="20px" @click="removeRange"></el-button>
                    </div>
                </div>
    ...
    export default {
        ...
        mounted: function () {
            ...
            API.getUnit(data1).then(res=>{
                ...
                let retired = this.list1[0];
                this.list1.shift();
                this.list1.push(retired);
        ...
        methods: {
            ...
            getxisuoList(){
                let data ={
                    token:Cookies.get('token'),
                    condition:{'unit_id': [15, 14, 13, 12, 11, 10, 9, 8, 7, 6]},
                    size:9999
                }
                API.Request_schema(data).then(res => {
                    this.list2 = res.list;
